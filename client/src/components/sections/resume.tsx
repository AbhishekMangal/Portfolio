      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
            Download my comprehensive resume to learn more about my technical skills, projects, and achievements.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className="text-2xl font-bold text-green-400 mb-2">1500+</div>
          ...
          <motion.a 
            href="https://drive.google.com/uc?export=download&id=1Fxo7fpq7w1ZmXtcmAx4u1s_DtOlf9xvx" 
            target="_blank"
